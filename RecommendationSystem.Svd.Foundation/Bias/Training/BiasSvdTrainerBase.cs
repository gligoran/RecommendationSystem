...
namespace RecommendationSystem.Svd.Foundation.Bias.Training
{
        ...
        where TBiasSvdModel : IBiasSvdModel
    {
        ...
        protected override void InitializeNewModel(TBiasSvdModel model, List<string> users, List<string> artists, List<IRating> ratings)
        {
        ...
        protected override float PredictRatingUsingResiduals(TBiasSvdModel model, int rating, int feature, List<IRating> ratings)
        {
        ...
        private void ComputeGlobalAverageAndBiases(TBiasSvdModel model, List<string> users, List<string> artists, List<IRating> ratings)
        {
